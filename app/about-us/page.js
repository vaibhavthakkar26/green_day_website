...
import { aboutBanner, meassageSectionMeassage, newslatterData, serviceDetails, video } from '../../lib/json/pagesData/aboutusPage/index'
...
import { InstagramPostDetails, TestimonialSectiondata } from '../../lib/json/pagesData/servicePage/serviceInner/shirodhara/index'
import TestimonialSection from '../components/testimonialSection'
import NewsLatter from '../components/newsLatter'
const AboutUs = () => {
  const AboutBannrData = aboutBanner
  const serviceDetailsdata = serviceDetails
  const meassageSectionData = meassageSectionMeassage
  const videoData = video
  const TestimonialData = TestimonialSectiondata
