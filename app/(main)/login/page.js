...
const Login = () => {
    return (
        <div className=' pt-[100px] md:pt-0 w-full max-w-[1920px] mx-auto flex flex-col items-center justify-center relative md:h-[600px] lg:h-[900px] xl:h-[950px] px-5 '>
            <div className='w-full max-w-[424px] mx-auto'>
                ...
                <div className='mt-[50px]'>
                    ...
                    <div className='bg-white/10 border-b-[1px] focus-within:border-[1px] basic-transition border-white flex items-center justify-between gap-3 p-2.5'>
                        <input type='number' placeholder={`+91 00000 00000`} className=' placeholder:text-base placeholder:font-OpenSans placeholder:text-white/10 bg-transparent outline-none block w-full' />
            ...
            <Image src={"/images/loginBgImage.svg"} alt='' width={1920} height={1060} className='absolute inset-0 h-[850px] lg:h-[900px] xl:h-[950px] md:block hidden -z-10' />
        </div>
    )
}
