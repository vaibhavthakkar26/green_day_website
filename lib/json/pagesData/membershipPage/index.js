...
export const premiummembarship = [

    {
        ...
        imageAndvideo1: [
            { type: "image", item: "/images/membershipimage1.png" },
            { type: "image", item: "/images/membershipimage2.png" },
        ],
        imageAndvideo2: [
            { type: "image", item: "/images/membershipimage3.png" },
            { type: "image", item: "/images/membershipimage4.png" },
        ],
        alignment: "right",
    }
]
...
export const tretment = {
    ...
    images1: [
        { type: "image", item: "/images/tretmentImage1.png" },
        { type: "image", item: "/images/tretmentImage2.png" },
    ],
    images2: [
        { type: "image", item: "/images/tretmentImage3.png" },
        { type: "image", item: "/images/tretmentImage4.png" },
    ],
    priceeList: [
        {
            title: "Sauna Relax",
